...
132 FLOAT m_fFadeTime = 0.0f,
 ...
 96 FLOAT m_fHPMultiplier "HP Multiplier" = 1.0f, // multiplies the monster's hp by this value
 ...
 ************************************************************/
  ...
  virtual FLOAT GetAttackMoveFrequency(FLOAT fEnemyDistance)
  {
    if (fEnemyDistance>GetProp(m_fCloseDistance)) {
      return 0.5f;
    } else if(m_fAttackRunSpeed<30.0f){
      return 0.25f;
    } else {
	  return 0.01f;
	}
  ...
  StandardBehavior(EVoid)
  {
    ...
    wait() {
	  ...
	  on(EChangeTarget eChangeTarget): {
	    m_penDeathTarget= eChangeTarget.penNewTarget;
		resume;
	  }
    }
  };
