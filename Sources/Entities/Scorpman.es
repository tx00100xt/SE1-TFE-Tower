  ...
  Main(EVoid) {
    ...
    switch (m_smtType) {
      case SMT_SOLDIER:
        ...
        SetHealth(300.0f * m_fHPMultiplier);
        m_fMaxHealth = 300.0f * m_fHPMultiplier;
      ...
      case SMT_GENERAL:
        ...
        SetModelSpecularTexture(TEXTURE_SPECULAR);
        SetHealth(600.0f * m_fHPMultiplier);
        m_fMaxHealth = 600.0f * m_fHPMultiplier;
        // damage/explode properties
      ...
      case SMT_MONSTER:
        ...
        SetModelMainTexture(TEXTURE_GENERAL);
        SetModelSpecularTexture(TEXTURE_SPECULAR);
        SetHealth(1200.0f * m_fHPMultiplier);
        m_fMaxHealth = 1200.0f * m_fHPMultiplier;
        // damage/explode properties
