...
// 17 INDEX m_iNukeBalls             "Nuke balls"    'U'   = MAX_NUKEBALLS,
 18 INDEX m_iSpikeballs            "Spikeballs"          = MAX_SPIKEBALLS,
...
//      m_iNapalm*AV_NAPALM + 
  ...
  void SetProperties(void)
  {
    ...
    if( m_iSpikeballs != 0) {m_strDescription.PrintF("%s: Spikeballs (%d)", (const char *) m_strDescription, m_iSpikeballs);}
...
procedures:
  ItemCollected(EPass epass) : CItem::ItemCollected
  {
	...
	eAmmo.iSpikeballs = m_iSpikeballs;
...
//    eAmmo.iNukeBalls = m_iNukeBalls;
  ...
  Main() {
    ...
    m_iSpikeballs = Clamp( m_iSpikeballs, INDEX(0), MAX_SPIKEBALLS);
