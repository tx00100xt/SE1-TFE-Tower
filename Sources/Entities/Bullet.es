...
// comp graphics algorithms sphere
  ...
  // launch one bullet
  // if iTrail = 0 no trail
  //             1 normal trail
  //             2 deathray trail
  void LaunchBullet(BOOL bSound, INDEX iTrail, BOOL bHitFX)
  {
 ...
 ************************************************************/
  ...
  void SpawnDeathrayTrail(void) 
  {
    ...
    ESpawnEffect ese;
	ese.betType= BET_DEATHRAY_TRAIL;
	ese.colMuliplier= RGBAToColor(255.0f, 0.0f, 255.0f, 255.0f);
    ese.vNormal = vD/fD;
	ese.vStretch= FLOAT3D(0.3f, fLen, 1.0f);
    SpawnEffect(vPos , ese);
  }
