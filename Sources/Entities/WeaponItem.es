...
event EWeaponItem {
  ...
  BOOL bGiveAlternateAmmo, // whether should give original SS ammo or new SS++ one
};
...
properties:
  ...
  2 BOOL m_bAlternateAmmo "Give Alternate Ammunition" = FALSE,
...
procedures:
  ItemCollected(EPass epass) : CItem::ItemCollected {
	...
	eWeapon.bGiveAlternateAmmo= m_bAlternateAmmo;
