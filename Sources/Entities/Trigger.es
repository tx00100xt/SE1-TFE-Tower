...
procedures:
  SendEventToTargets() {
	...
	/*
	if(IsOfClass(m_penTarget1, "Camera"))
	{
		CPrintF("Sent event to camera\n");
	}
	if(IsOfClass(m_penTarget2, "Camera"))
	{
		CPrintF("Sent event to camera\n");
	}
	if(IsOfClass(m_penTarget3, "Camera"))
	{
		CPrintF("Sent event to camera\n");
	}
	if(IsOfClass(m_penTarget4, "Camera"))
	{
		CPrintF("Sent event to camera\n");
	}
	if(IsOfClass(m_penTarget5, "Camera"))
	{
		CPrintF("Sent event to camera\n");
	}
	if(IsOfClass(m_penTarget6, "Camera"))
	{
		CPrintF("Sent event to camera\n");
	}
   	if(IsOfClass(m_penTarget7, "Camera"))
	{
		CPrintF("Sent event to camera\n");
	}
	if(IsOfClass(m_penTarget8, "Camera"))
	{
		CPrintF("Sent event to camera\n");
	}*/
