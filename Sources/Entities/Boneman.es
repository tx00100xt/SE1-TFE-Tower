 ...
 ************************************************************/
  Fire(EVoid) : CEnemyBase::Fire {
    ...
    DeactivateRunningSound();
    autowait(0.35f);
    ShootProjectile(PRT_BONEMAN_FIRE, FIRE_RIGHT_HAND*m_fStretchMultiplier, ANGLE3D(0, 0, 0));
    PlaySound(m_soSound, SOUND_FIRE, SOF_3D);
    autowait(0.45f);
    ShootProjectile(PRT_BONEMAN_FIRE, FIRE_LEFT_HAND*m_fStretchMultiplier, ANGLE3D(0, 0, 0));
    PlaySound(m_soSound, SOUND_FIRE, SOF_3D);
 ...
 ************************************************************/
  Main(EVoid) {
    ...
    SetHealth(125.0f * m_fHPMultiplier);
    m_fMaxHealth = 125.0f * m_fHPMultiplier;
    en_fDensity = 2000.0f;
