...
/*      case ELT_STONE: 
    ...
    if (m_EecChar==ELC_LARGE)
    {
      ...
      m_bBoss = TRUE;
      SetHealth(10000.0f * m_fHPMultiplier);
      m_fMaxHealth = 10000.0f * m_fHPMultiplier;
    ...
    else if (m_EecChar==ELC_BIG)
    {
      ...
      SetHealth(800.0f * m_fHPMultiplier);
      m_fMaxHealth = 800.0f * m_fHPMultiplier;
      // after loosing this ammount of damage we will spawn new elemental
    ...
    {
      m_sptType = SPT_LAVA_STONES;
      SetHealth(100.0f * m_fHPMultiplier);
      m_fMaxHealth = 100.0f * m_fHPMultiplier;
      // setup moving speed
      m_fWalkSpeed = FRnd() + 1.5f;
      m_aWalkRotateSpeed = AngleDeg(FRnd()*10.0f + 25.0f);
