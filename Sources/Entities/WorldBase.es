...
// pulsating
  ...
  // a ladder- very climable
  // (ADD) didn't work; try adding StickyFeet when touching
  ASSERT(14==SURFACE_LADDER);
  pwo->wo_astSurfaceTypes[14].st_strName = "Ladder";
  pwo->wo_astSurfaceTypes[13].st_fFriction = 1.0f;
  pwo->wo_astSurfaceTypes[13].st_fStairsHeight = 1.0f;
  pwo->wo_astSurfaceTypes[13].st_fJumpSlopeCos = Cos(45.0f);
  pwo->wo_astSurfaceTypes[13].st_fClimbSlopeCos = Cos(45.0f);
  ...
  /*
  pwo->wo_astSurfaceTypes[14].st_fFriction = 40.0f;
  pwo->wo_astSurfaceTypes[14].st_fStairsHeight = 2.0f;
  pwo->wo_astSurfaceTypes[14].st_fJumpSlopeCos = Cos(180.0f);
  pwo->wo_astSurfaceTypes[14].st_fClimbSlopeCos = Cos(180.0f);
  */
