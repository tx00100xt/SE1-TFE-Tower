...
// ********* GRENADES *********
 ...
 34 texture TEXTURE_SPIKEBALLS    "Models\\Items\\Ammo\\Grenades\\Spikeball.tex",
  ...
  BOOL FillEntityStatistics(EntityStats *pes)
  {
    ...
    switch (m_EaitType) {
      ...
      case AIT_ROCKETS:     
        ...
        break;
	  case AIT_SPIKEBALLS:
		pes->es_strName= "Spikeballs";
		pes->es_fValue= m_fValue*AV_SPIKEBALLS;
      case AIT_GRENADES:    
  ...
  void SetProperties(void) {
    switch (m_EaitType) {
	  ...
	  case AIT_SPIKEBALLS:
		m_fValue= 5.0f;
		m_fRespawnTime= 30.0f;
		m_strDescription.PrintF("Spikeballs: %d", (int) m_fValue);
		// set appearance
		AddItem(MODEL_GRENADES, TEXTURE_SPIKEBALLS, 0, 0, 0);
		AddFlare(MODEL_FLARE, TEXTURE_FLARE, FLOAT3D(0, 0.6f,0), FLOAT3D(4,4,1.0f) );
		StretchItem(FLOAT3D(0.75f, 0.75f, 0.75f));
		break;
      case AIT_ELECTRICITY:
