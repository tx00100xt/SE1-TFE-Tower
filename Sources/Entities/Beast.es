 ...
 ************************************************************/
  Fire(EVoid) : CEnemyBase::Fire
  {
    ...
    if( m_bcType == BT_NORMAL)
    {
      ...
      ShootProjectile(PRT_BEAST_PROJECTILE, FLOAT3D( 0.0f, 1.5f*BEAST_STRETCH, 0.0f)*m_fStretchMultiplier,
    ...
    if( m_bcType == BT_BIG)
    {
      if( GetHealth() <= m_fMaxHealth/2)
      {
        ...
        while ( m_iCounter<6)
        {
          ...
          PlaySound(m_soSound, SOUND_FIRE, SOF_3D);
          autowait(0.34f);
          ShootProjectile(PRT_BEAST_BIG_PROJECTILE, FLOAT3D( 0.0f, 1.5f*BIG_BEAST_STRETCH, 0.0f)*m_fStretchMultiplier,
 ...
 ************************************************************/
  Main(EVoid) {
    ...
    if( m_bcType == BT_NORMAL)
    {
      ...
      SetHealth(400.0f * m_fHPMultiplier);
    ...
    else
    {
      ...
      SetHealth(2000.0f * m_fHPMultiplier);//500
