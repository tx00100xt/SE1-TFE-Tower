...
properties:
 ...
 16 BOOL m_bFloats "Floats" 'F' = FALSE, // not affected by gravity
 17 BOOL m_bNotUsed = FALSE, // checking whether it'll cause the floats entities list to disappear
 ...
 ************************************************************/
  void Initialize(void) {
	...
	if(m_bFloats)
	{
		SetPhysicsFlags(EPF_MODEL_SLIDING & ~EPF_TRANSLATEDBYGRAVITY /* & ~EPF_MOVABLE */);
	}
	else
	{
